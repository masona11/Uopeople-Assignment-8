...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText(
				"I have enjoyed taking Programming 2.\n" +
				"I think the class was very challenging,\n" +
		...
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/code.jpeg"));
		...
		// Create the "Stamper" menu using the createMenu() method from IconSupport.
		...
		// Add the "Stamper" menu to the menu bar.
